...
const Hero = () => {
    ...
    const sectionClasses = 'container mx-auto rounded-2xl mt-5 text-white text-center space-y-3'
    return (
        <>
            <div className={sectionClasses} id='hero-background'>
                ...
                <button className='credit-button'><span className='border-4 px-5 py-3 rounded-xl'>Claim Free Credit</span></button>
            </div>
        </>
    );
};
